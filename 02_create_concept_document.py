...
# Create comprehensive GraphRAG concept document
concept_content = """# EU GraphRAG - Detailed Concept Document
...
# Write to file
with open("/home/mbuchhorn/projects/EU_GraphRAG/docs/GraphRAG-Concept.md", "w", encoding="utf-8") as f:
    f.write(concept_content)

print("✓ Created comprehensive GraphRAG concept document")
print(f"  File: /home/mbuchhorn/projects/EU_GraphRAG/docs/GraphRAG-Concept.md")
print(f"  Size: {len(concept_content)} characters")
